...
<div id="app">
  <nav id="sidebar">
    <ul class="nav-links">
      ...
      <li><a href="#" data-page="corrections"><span class="nav-icon">&#8635;</span> Corrections<span class="nav-badge" id="badge-corrections"></span></a></li>
      <li><a href="#" data-page="playbook"><span class="nav-icon"><svg width="16" height="16" viewBox="0 0 16 16" fill="none"><path d="M2 2h12v12H2z" stroke="currentColor" stroke-width="1.2" fill="none"/><path d="M5 5h6M5 8h6M5 11h4" stroke="currentColor" stroke-width="1.2" stroke-linecap="round"/></svg></span> Playbook<span class="nav-badge" id="badge-playbook"></span></a></li>
      <li><a href="#" data-page="tool-proficiency"><span class="nav-icon"><svg width="16" height="16" viewBox="0 0 16 16" fill="none"><path d="M2 4l6-2 6 2v3c0 3.5-2.5 6.5-6 8-3.5-1.5-6-4.5-6-8V4z" stroke="currentColor" stroke-width="1.2" fill="none"/><path d="M6 8l1.5 1.5L10 6" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg></span> Skills<span class="nav-badge" id="badge-tools"></span></a></li>
      <li><a href="#" data-page="roi"><span class="nav-icon"><svg width="16" height="16" viewBox="0 0 16 16" fill="none"><path d="M2 3h12v5a4 4 0 01-4 4H6a4 4 0 01-4-4V3z" stroke="currentColor" stroke-width="1.2" fill="none"/><path d="M5 2V1m6 1V1M4 7h2m0 0h2m-2 0V5m0 2v2" stroke="currentColor" stroke-width="1.2" stroke-linecap="round"/></svg></span> ROI<span class="nav-badge" id="badge-roi"></span></a></li>
      <li><a href="#" data-page="practice"><span class="nav-icon"><svg width="16" height="16" viewBox="0 0 16 16" fill="none"><circle cx="8" cy="8" r="6.5" stroke="currentColor" stroke-width="1.3" fill="none"/><path d="M8 5v3l2 2" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/></svg></span> Practice<span class="nav-badge" id="badge-practice"></span></a></li>
